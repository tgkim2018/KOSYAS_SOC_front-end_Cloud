...
/*
  ...
  public barChartData: any[] = [
    {data: [65, 59, 80, 81, 56, 55, 65, 59, 80, 81, 56, 55], label: 'Alert'},
  ];
*/
...
public bar2ChartData: any[] = [
  ...
  public pieChartData: number[] = [23, 32, 47];
  ...
  // Pie3
  public pie3ChartLabels: string[] = ['Web-script Inject', 'system-DDoS', 'network-flooding', 'network-hashcheck', 'system-testrule'];
  public pie3ChartData: number[] = [12, 32, 77, 7, 21];
  public pie3ChartType = 'pie';

// Pie4
public pie4ChartLabels: string[] = ['localhost', '192.168.0.111', '192.168.0.125', '192.168.0.115', '192.168.0.100'];
public pie4ChartData: number[] = [212, 432, 177, 17, 21];
public pie4ChartType = 'pie';
